    ...
    <table class="table tables table-bordereds table-hovers">
        ...
        <tr>
            ...
            <td><select name="tipodocumento" class="form-control" readonly onmouseover="this.disabled=true;" onmouseout="this.disabled=false;">
                    ...
                    <option value="otros" <?=$hr['tipodocumento'] == "otros" ? 'selected="selected"' : '';?>>Otros</option>
...
?>
        ...
        <tr class="contrato">
            ...
            <td><input type="text" name="contratominuta" class="form-control"  value="<?=$c['contratominuta'];?>"></td>
        </tr>
        <tr class="contrato">
